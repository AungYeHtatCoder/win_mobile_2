 ...
 <section class="container justify-content-center align-items-center aboutus" style="padding-top: 8rem;">
  ...
  <div class="text-center">
   <p class="fw-bold">
    ...
    <span style="font-size: larger;">ရောင်းသူ ဝယ်သူအဆင်ပြေအောင် ညှိနှိင်းဆောင်ရွက်ပေးပြီး ယုံကြည်စိတ်ချစွာ
     ဝယ်ယူအားပေးနိုင်ပါသည်</span>
    <span style="font-size: 40px;">"</span>
   </p>
  </div>
  ...
  <div class="row mt-5">
   ...
   <img src="./assets/banner3.jpg" alt="" class="col-lg-4 col-md-6">
  </div>
