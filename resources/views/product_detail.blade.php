      ...
      <div class="col-2">
       <h6 class="text-warning">Storage</h6>
        ...
        <div class="col-1 mt-1">
            <input id="radio-{{ $price->id }}" type="checkbox" name="selected_price"
            class="price-enable">
        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-prepend">
                                    <button class="btn btn-outline-warning rounded-left" type="button" onclick="changeValue(this, -1)">-</button>
                                </span>
                                <input type="number" class="form-control text-dark text-center px-3" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" min="1" max="10" value="1">
                                <span class="input-group-append">
                                    <button class="btn btn-outline-warning rounded-right" type="button" onclick="changeValue(this, 1)">+</button>
                                </span>
                            </div>
                        </div>
                        <div class="input-group">
