    ...
    <section class="container mt-md-5 mt-sm-3">
        <div class="row">
                ...
                <div class="row">
                    <div class="owl-carousel owl-theme mt-4 p-5" id="product-details-carousel">
                        <div class="item" data-item-id="1">
                            <div class="card">
                                <div class="card-body d-flex justify-content-center">
                                    <img src="./assets/Samsung-Galaxy-S23-SOURCE-Samsung.png"
                        ...
                        <div class="item" data-item-id="2">
                            <div class="card">
                                <div class="card-body d-flex justify-content-center">
                                    <img src="./assets/Oppo_reno6.jpg" class="img-fluid card-image-top w-75"
                                        alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item" data-item-id="4">
                            <div class="card">
                                <div class="card-body d-flex justify-content-center">
                                    <img src="./assets/xiaomi-redmi-note-10-1650374785.jpg"
                                        class="img-fluid card-image-top w-75" alt="">
                                </div>
                            </div>
                        </div>
          ...
          <a href="#!" class="text-black-50"><i class="fas fa-heart"><span class="mx-1">Add to Whishlist</span></i></a>
                            ...
                            <div class="col-sm-3 my-1">
                                <div class="input-group">
                                    ...
                                    <input id="numberInput" type="number"
                                        class="form-control text-dark text-center px-3"
                ...
                <div class="mt-2">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus, eveniet animi quam
                        repellendus
                        illum
                        deleniti rerum minus doloremque adipisci dolor, labore rem consequatur exercitationem corrupti
                        voluptatibus
                        dolorum
                        incidunt reiciendis molestiae! Veniam eos quam dolorem doloremque, minima corporis vel labore
                        porro,
                        molestiae, sit
            ...
            <div class="col-md-6 shadow p-3">
                <form action="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12 mb-2">
                            <input type="number" class="form-control" placeholder="Your rating (1-5)"
                                aria-label="email">
                        </div>
                    </div>
                    <div class="mb-md-3 mt-2">
                        <textarea class="form-control" name="" id="" cols="30" rows="5"
                            placeholder="What's your review?"></textarea>
                    </div>
