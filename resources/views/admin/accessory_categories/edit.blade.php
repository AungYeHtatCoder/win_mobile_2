    ...
    <div class="col-md-10">
     <div id="formGrid" class="mb-5">
      <div class="d-flex justify-content-between">
       <h4>Accessory Category Edit</h4>
       <p><a href="{{ route('admin.accessory_categories.index') }}" class="btn btn-primary"><i
          class="fas fa-arrow-left me-1"></i>Back</a></p>
      </div>
      <div class="card">
       <div class="card-body">
        <form action="{{ route('admin.accessory_categories.update', $category->id) }}" method="post">
         @csrf
         @method("PUT")
         <div class="mb-3 row">
