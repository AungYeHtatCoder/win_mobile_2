   ...
   <div class="row">
    ...
    <div class="col-xl-9">
     ...
     <div id="datatable" class="mb-5">
      <h4><a href="{{ route('admin.rams.index') }}" class="btn btn-primary">Back To RAM Dashboard</a></h4>
      <p></p>
      <div class="card">
       <div class="card-body">
        <table id="" class="table text-nowrap w-100">
         ...
         <tr>
          <th>RAM Name</th>
          <td>{{ $ram_detail->name }}</td>
         </tr>
         <tr>
          <th>Created At</th>
          <td>{{ $ram_detail->created_at }}</td>
         </tr>
         <tr>
          <th>Updated At</th>
          <td>{{ $ram_detail->updated_at }}</td>
         </tr>
        </table>
       </div>
