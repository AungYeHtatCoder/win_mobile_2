						...
						<div class="row">
							...
							<div class="col-xl-12">
								...
								<div id="datatable" class="mb-5">
									<h4 class="text-end"><a href="{{ route('admin.categories.create') }}" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Category Create</a></h4>
									<p></p>
									<div class="card">
										<div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('admin.categories.show', $category->id) }}" class="btn btn-sm btn-info">Show</a>
