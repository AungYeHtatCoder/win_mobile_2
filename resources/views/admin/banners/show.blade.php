						...
						<div class="row">
							...
							<div class="col-xl-12">
								...
								<div id="datatable" class="mb-5">
									<h4 class="text-end"><a href="{{ route('admin.banners.index') }}" class="btn btn-primary"><i class="fas fa-arrow-left me-1"></i>Back</a></h4>
									<div class="card">
										<div class="card-body">
                                            <h4>Banner Image</h4>
                                            <img src="{{ $banner->img_url }}" class="w-75 img-thumbnail" alt="">
                                            <p class="mt-3">
                                                Posted Date -
