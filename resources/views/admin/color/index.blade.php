   ...
   <div class="row">
    ...
    <div class="col-xl-12">
     <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Color Dashboard</li>
     </ul>
     ...
     <div id="datatable" class="mb-5">
      <h4><a href="{{ route('admin.colors.create') }}" class="btn btn-primary">New Color Create</a></h4>
      <p></p>
      <div class="card">
       <div class="card-body">
        <table id="datatableDefault" class="table text-nowrap w-100">
         ...
         <tbody>
          ...
          <tr>
           <td>{{ ++$key }}</td>
           <td>{{ $color->name }}</td>
           <td>{{ $color->created_at->format('F j, Y') }}</td>
           <td>{{ $color->updated_at->format('F j, Y') }}</td>
           <td>
            <a href="{{ route('admin.colors.edit', $color->id) }}" class="btn btn-primary btn-sm">Edit</a>
            <a href="{{ route('admin.colors.show', $color->id) }}" class="btn btn-info btn-sm">Show</a>
