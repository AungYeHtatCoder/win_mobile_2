...
<div class="row">
 <div class="col-md-8">
  <div id="formGrid" class="mb-5">
   ...
   <div class="card">
    <div class="card-body">
     <form action="{{ route('admin.colors.update', $color_edit['id']) }}" method="post">
      @csrf
      @method('PUT')
      <div class="mb-3 row">
       <label for="inputEmail3" class="col-sm-2 col-form-label">Color Name</label>
       <div class="col-sm-10">
        <input type="text" class="form-control" value="{{ $color_edit->name }}" id="inputEmail3" name="name">
       </div>
      </div>

      <div class="form-group row">
       <div class="col-sm-10 offset-sm-2">
        <button type="submit" class="btn btn-outline-theme">Create New Color</button>
       </div>
      </div>
     </form>
    </div>
