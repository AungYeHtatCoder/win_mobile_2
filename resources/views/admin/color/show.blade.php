   ...
   <div class="row">
    ...
    <div class="col-xl-9">
     ...
     <div id="datatable" class="mb-5">
      <h4><a href="{{ route('admin.colors.index') }}" class="btn btn-primary">Back To Color Dashboard</a></h4>
      <p></p>
      <div class="card">
       <div class="card-body">
        <table id="" class="table text-nowrap w-100">
         <tr>
          <th>ID</th>
          <td>{{ $color_detail->id }}</td>
         </tr>
         <tr>
          <th>Color Name</th>
          <td>{{ $color_detail->name }}</td>
         </tr>
         <tr>
          <th>Created At</th>
          <td>{{ $color_detail->created_at }}</td>
         </tr>
         <tr>
          <th>Updated At</th>
          <td>{{ $color_detail->updated_at }}</td>
         </tr>
        </table>
       </div>
