   ...
   <div class="row">
    ...
    <div class="col-xl-12">
     ...
     <div id="datatable" class="mb-5">
      <h4 class="text-end">
       <a href="{{ route('admin.products.index') }}" class="btn btn-outline-theme"><i
         class="fas fa-arrow-left me-2"></i>Back</a>
       <a href="{{ url('/admin/products/prices/create/'.$product->id) }}" class="btn btn-primary"><i
         class="fas fa-plus me-1"></i>Product Price Create</a>
      </h4>
      <p></p>
      <div class="card">
       <div class="card-body">
