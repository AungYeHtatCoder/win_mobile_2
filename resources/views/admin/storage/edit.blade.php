...
<div class="row">
 <div class="col-md-8">
  <div id="formGrid" class="mb-5">
   ...
   <div class="card">
    <div class="card-body">
     <form action="{{ route('admin.storages.update', $storage_edit['id']) }}" method="post">
      @csrf
      @method('PUT')
      <div class="mb-3 row">
       <label for="inputEmail3" class="col-sm-2 col-form-label">Storage Name</label>
       <div class="col-sm-10">
        <input type="text" class="form-control" value="{{ $storage_edit->name }}" id="inputEmail3" name="name">
       </div>
      </div>
