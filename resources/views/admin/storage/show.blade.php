   ...
   <div class="row">
    ...
    <div class="col-xl-9">
     <ul class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Stroage Dashboard</li>
     </ul>
     ...
     <div id="datatable" class="mb-5">
      <h4><a href="{{ route('admin.storages.index') }}" class="btn btn-primary">Back To Storage Dashboard</a></h4>
      <p></p>
      <div class="card">
       <div class="card-body">
        <table id="" class="table text-nowrap w-100">
         <tr>
          <th>ID</th>
          <td>{{ $storage_detail->id }}</td>
         </tr>
         <tr>
          <th>Storage Name</th>
          <td>{{ $storage_detail->name }}</td>
         </tr>
         <tr>
          <th>Created At</th>
          <td>{{ $storage_detail->created_at }}</td>
         </tr>
         <tr>
          <th>Updated At</th>
          <td>{{ $storage_detail->updated_at }}</td>
         </tr>
        </table>
       </div>
