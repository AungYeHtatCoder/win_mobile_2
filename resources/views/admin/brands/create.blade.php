                ...
                <div class="col-md-10">
                    <div id="formGrid" class="mb-5">
                        <div class="d-flex justify-content-between">
                            <h4>Brand Create</h4>
                            <p><a href="{{ route('admin.brands.index') }}" class="btn btn-primary"><i class="fas fa-arrow-left me-1"></i>Back</a></p>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.brands.store') }}" method="post">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputEmail3" name="name" placeholder="Enter Brand Name">
                                            @error('name')
