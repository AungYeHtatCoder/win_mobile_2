						...
						<div class="row">
							...
							<div class="col-xl-12">
								...
								<div id="datatable" class="mb-5">
									<h4 class="text-end"><a href="{{ route('admin.brands.create') }}" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Brand Create</a></h4>
									<p></p>
									<div class="card">
										<div class="card-body">
											<table id="datatableDefault" class="table text-nowrap w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ $brand->created_at->format('j M, Y') }}
                                                        </td>
                                                        <td>
                                                            <a href="{{ route('admin.brands.edit', $brand->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                            <a href="{{ route('admin.brands.show', $brand->id) }}" class="btn btn-sm btn-info">Show</a>
                                                            <form action="{{ route('admin.brands.destroy', $brand->id) }}" class="d-inline" method="POST">
                                                                @csrf
                                                                @method('DELETE')
