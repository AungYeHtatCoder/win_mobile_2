   ...
   <div class="col-lg-6 col-sm-12">
    <div class="row">
     <div class="col-md-4 col-sm-12 side_img">
      <div class="mb-3 card">
       <div class="d-flex flex-column">
        ...
        <a href="/product-details" class="text-dark mb-3 fw-bold">Apple Air Pod (2 Gen)</a href="">
       </div>
       <div>
     ...
     <div class=" col-md-4 col-sm-12 mt-2 side_img">
      <div class="mb-3 card">
       <div class="d-flex flex-column">
        <img src="./assets/H33b9cc895f3844fd948467beb797def81.jpg_300x300.png" class="img-fluid mx-auto" alt="Avatar">
