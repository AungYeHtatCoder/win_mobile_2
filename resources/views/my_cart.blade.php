        ...
        <div class="row">
                            ...
                            <div class="row border mb-md-2 p-md-2">
                                <div class="col-md-9 d-flex">
                                    ...
                                    <div class="mx-3 text-secondary">
                                        <h5>{{ $cart->product->name }}<sup
                                                class="text-success"><small>{{ $cart->product_prices->category->name }}</small></sup>
                                        </h5>
                        ...
                        @else
                            <div class="row border mb-md-2 p-md-2">
                                <div class="col-md-9 d-flex">
                                    ...
                                    <div class="mx-3 text-secondary">
                                        <h5>{{ $cart->accessory->name }}<sup
                                                class="text-success"><small>{{ $cart->accessory->category->name }}</small></sup>
                                        </h5>
                                        <h6>Color: {{ $cart->color->name }}</h6>
                                        {{-- <span class="d-block">Storage: {{ $cart->product_prices->storage->name }}</span> --}}
                                        {{-- <span class="d-block">RAM: {{ $cart->product_prices->ram->name }}</span> --}}
            ...
            @guest
                <section class="container my-md-5">
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center align-content-center mx-auto">
